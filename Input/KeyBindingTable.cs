...
internal sealed class KeyBindingTable
{
    ...
    internal static List<KeyRow> DefaultRows() => new()
    {
        ...
        R(ConsoleKey.X, EditorCommand.RegisterPick, ctrl: true),
        ...
        R(ConsoleKey.L, EditorCommand.SurroundAdd, ctrl: true),
        ...
        R(ConsoleKey.L, EditorCommand.SurroundChange, alt: true),
        R(ConsoleKey.J, EditorCommand.SurroundDelete, alt: true),
